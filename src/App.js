...
class App extends Component {
  ...
  render() {
      const props = {
          ...
          rows: [
              {firstName:'Arch',lastName:'Lehner',email:'ARicardo_Vandervort@hotmail.com',address:'615 Heath Ports',city:'Leafort',state:'Maryland',country:'Wallis and Futuna',zipCode:'77401-4917',bio:'Placeat quis cum soluta vel sunt.',isOpen:false},
